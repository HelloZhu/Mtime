...
-(void)operateNavigationLeftBar
{
    ...
    [leftBtn setBackgroundImage:[UIImage imageNamed:@"map_back_button.png"] forState:UIControlStateNormal];
    leftBtn.frame=CGRectMake(0, 0, 60, 30);
    [leftBtn addTarget:self action:@selector(gotoContentView) forControlEvents:UIControlEventTouchUpInside];
    ...
    [rightBtn addTarget:self action:@selector(gotoImageList) forControlEvents:UIControlEventTouchUpInside];
    [rightBtn setBackgroundImage:[UIImage imageNamed:@"movie_pic_listicon.png"] forState:UIControlStateNormal];
...
//    
//    [self.navigationController popToViewController:tab.movieContentCtrl animated:YES];
